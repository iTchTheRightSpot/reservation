...
import { CreateScheduleModel } from '@crm/pages/account/pages/schedule/schedule.model';
...
export class CreateScheduleComponent {
  ...
  protected readonly submit = (staffId: string) => {
    ...
    this.createScheduleEmitter.emit(<CreateScheduleModel>{
      staff_id: staffId,
      start: this.form.controls['date_time'].value,
