...
type IStaffServiceStore interface {
	Save(ctx context.Context, s *staff.StaffServiceEntity) (*staff.StaffServiceEntity, error)
...
func (dep *staffServiceStore) Save(ctx context.Context, s *staff.StaffServiceEntity) (*staff.StaffServiceEntity, error) {
	q := `
