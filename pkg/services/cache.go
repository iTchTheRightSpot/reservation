...
// NewInMemoryCache duration is in minutes
func NewInMemoryCache[K any, V any](l utils.ILogger, duration, size int) ICache[K, V] {
...
func (dep *inMemoryCache[K, V]) leastUser() K {
	var k K
	now := dep.logger.Date()
	lastAccess := &now
